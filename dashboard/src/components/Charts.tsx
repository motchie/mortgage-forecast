...
export function ForecastLineChart({ title, description, series, valueLabel, showChart = true }: { title: string; description: string; series: Series[]; valueLabel: string; showChart?: boolean }) {
